...
class r : baseMan {
	...
	primaryWeapon[] = {"CUP_arifle_G36A_RIS"};
	scope[] = {"cup_optic_holoblack","cup_optic_eotech553_black"};
	magazines[] = {
...
class g : r {
	...
	primaryWeapon[] = {"CUP_arifle_G36A_AG36_RIS"};
	magazines[] += {
...
class ar : r {
	...
	magazines[] = {
		LIST_6("CUP_120Rnd_TE4_LRT4_Yellow_Tracer_762x51_Belt_M"),
		"HandGrenade",
		"SmokeShell"
	};
};
